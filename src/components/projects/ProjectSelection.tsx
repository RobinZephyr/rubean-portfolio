...
function ProjectSelection({ onProjectSelect }: ProjectSelectionProps) {
  ...
  const onClickChangeProject = (projectId: number) => {
    ...
    gsap.set(".projectTransition", { scaleX: 0, opacity: 0.5 });
    ...
    gsap.set(".projectTextboxText", { opacity: 0.0 });
  ...
  return (
    <div className="h-50% w-full flex justify-center ">
      ...
      <div className="mt-5 pt-6 pb-2  overflow-y-auto scroll2 h-[270px] gap-5 max-w-[300px] md:max-w-[450px]  bg-skillMenu flex flex-wrap relative whitespace-pre justify-center">
